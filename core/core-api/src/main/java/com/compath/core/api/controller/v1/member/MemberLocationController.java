...
import com.compath.core.api.domain.member.location.MemberLocationService;
...
public class MemberLocationController {
	...
	public ApiResponse<LocationResponse> updateLocation(
		...
		LocationResponse response = memberLocationService.updateLocation(memberId, request);
